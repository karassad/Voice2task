...
async def send_new_message(update: Update, context: ContextTypes.DEFAULT_TYPE, text: str, reply_markup=None, parse_mode=None):
    '''
...
async def edit_message(update: Update, context: ContextTypes.DEFAULT_TYPE, text: str, reply_markup=None, parse_mode=None):
    ...
    if not last_message_id:
        ...
        return await send_new_message(update, context, text, reply_markup=None, parse_mode=None)
...
async def send_smart_message(update: Update, context: ContextTypes.DEFAULT_TYPE, text: str, last_message: bool, reply_markup=None, parse_mode=None):
    """
    ...
    if not last_message:
        await send_new_message(update, context, text, reply_markup, parse_mode)
    else:
        await edit_message(update, context, text, last_message, parse_mode)
